...
<nav role="navigation" class="navbar navbar-default">
    ...
    <div id="navbarCollapse" class="collapse navbar-collapse">
        <ul class="nav navbar-nav">
            <li class="active"><a href="<?php echo site_url('examples/offices_management')?>">Home</a></li>
            <li><a href="<?php echo site_url('examples/offices_management')?>">Employés</a></li>          
            ...
            <li><a href='<?php echo site_url('examples/resa')?>'>Réservations</a></li>
        </ul>
